...
if __name__ == "__main__":
    ...
    print("Greedy order by deadline:")
    print_tasks(apply_permutation(tasks, greedy_by_deadline(tasks)))
    print(f"Penalty in Greedy order: {calculate_Cmax(apply_permutation(tasks, greedy_by_deadline(tasks)))}")
    print("Optimal order by DP:")
    print_tasks(apply_permutation(tasks, find_optimal_task_order(tasks)))
